   ...
   // float leftMotorSpeed = 1;
    ...
    if (clientID!=-1){
     ...
     int x=1;
			...
			/*int flag=0;
			//checking if a turn has come
			if(sensor[0]<0.6 && sensor[1]<0.6 && sensor[2]<0.6 && sensor[3]>0.6)			//left turn detected
			{
				flag=1;
				if(sensor[0]>0.6 && sensor[1]<0.6 && sensor[2]<0.6 && sensor[3]>0.6){		//straight line
			...
			else if(sensor[0]>0.6 && sensor[1]<0.6 && sensor[2]<0.6 && sensor[3]<0.6)		//right turn detected
			{
				flag=1;
				if(sensor[0]>0.6 && sensor[1]<0.6 && sensor[2]<0.6 && sensor[3]>0.6){		//straight line
					move(clientID,leftMotorHandle,rightMotorHandle,0,0);
			...
			printf("agaya andar ab majje kar\n");
            ...
            printf("the sensor values***: %f %f %f %f\n",svalue[0],svalue[1],svalue[2],svalue[3]);
				...
				if(sensor[0]>0.6 && sensor[1]<0.6 && sensor[2]<0.6 && sensor[3]>0.6)
				{		//straight line
					printf("bye bye ");
					x=0;
					break;
			            ...
			            if(sensor[3]<0.6 && sensor[1]<0.6 && sensor[2]<0.6 && sensor[0]>0.6)			//right turn detected
			{    
			    
			    printf("aagaya aandar");
				while(x)
                              {   
